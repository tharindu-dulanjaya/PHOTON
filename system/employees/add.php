...
// validate mobile number
    ...
    if (empty($message)) {
        ...
        $sql = "INSERT INTO employees(AppointmentDate,DesignationId,DepartmentId,UserId) "
                . "VALUES ('$app_date','$designation_id','$department_id','$UserId')";
        $db->query($sql);
        $EmpId = $db->insert_id;
        ...
        <div class="card card-primary">
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" novalidate>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <?php
                            // admin cannot be added again
                            $sql = "SELECT * FROM designations WHERE Id != '1'";
                            $result = $db->query($sql);
                            ?>
                ...
                <div class="card-footer text-right">
                    <button type="submit" class="btn btn-primary" <?= $privilege['Add'] == '0' ? 'disabled' : '' ?>>Add Employee</button>
                </div>
            </form>
        </div>
    </div>
