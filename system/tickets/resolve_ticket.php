...
<script>
    ...
    $(document).ready(function () {
        ...
        var calendar = new Calendar(calendarEl, {
            ...
            editable: true,
            droppable: true, // this allows drop events onto the calendar
            drop: function (info) {
                var currentDate = new Date(); //gets the current date and time
                var dropDate = info.date; // date where the event is dropped

                // Disable dropping on past dates
                if (dropDate < currentDate.setHours(0, 0, 0, 0)) {
                    Swal.fire({
                        icon: "error",
                        title: "",
                        text: "Cannot assign past dates!",
                        showConfirmButton: false,
                        timer: 2500
                    });
