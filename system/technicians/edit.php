...
$link = "Update Technician Details";
$breadcrumb_item = "Technicians";
$breadcrumb_item_active = "Update";

if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    extract($_GET); //to get the user id
    $sql = "SELECT * FROM users u "
            . "INNER JOIN employees e ON e.UserId=u.UserId "
            . "INNER JOIN technicians t ON t.EmpId=e.EmployeeId "
    ...
    $EmpId = $row['EmployeeId']; // send in a hidden variable to update technicians table
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($message)) {
        ...
        $sql = "UPDATE employees SET AppointmentDate='$app_date',DesignationId='7',DepartmentId='5' WHERE UserId='$UserId'";
        $db->query($sql);
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control" id="app_date" name="app_date" value="<?= @$app_date ?>">
