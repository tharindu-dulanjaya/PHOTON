                                    ...
                                    <td>
                                        <div class="btn-group btn-group">
                                            ...
                                            if ($row['PO_Status'] == '1') { //still pending
                                                echo "purchase_orders/pending_po_details.php?po_id=" . $row['PO_Id'];
                                            } elseif ($row['PO_Status'] == '2') { // po accepted
                                                echo "purchase_orders/accepted_po_details.php?po_id=" . $row['PO_Id'];
                                            } elseif ($row['PO_Status'] == '3') { // po rejected
                                                echo "purchase_orders/rejected_po_details.php?po_id=" . $row['PO_Id'];
                                            } elseif ($row['PO_Status'] == '4') { // paid
                                                echo "purchase_orders/paid_po_details.php?po_id=" . $row['PO_Id'];
                                            } elseif ($row['PO_Status'] == '5') { // payment confirmed
                                                echo "purchase_orders/paid_po_details.php?po_id=" . $row['PO_Id'];
                                            } elseif ($row['PO_Status'] == '6') { // payment failed
                                                echo "purchase_orders/paid_po_details.php?po_id=" . $row['PO_Id'];
                                            ...
                                            <a href="<?= SYS_URL ?>purchase_orders/edit_details.php?po_id=<?= $row['PO_Id'] ?>" class="btn btn-outline-dark <?= $privilege['Edit'] == '0' ? 'disabled' : '' ?> <?= $row['PO_Status'] == '1' ? '' : 'disabled' ?>  " readonly><i class="fas fa-edit"></i> Edit</a>
                                        </div>
                                    </td>
                                </tr>
