...
$privilege = checkprivilege('3'); // 3 is the module id
?> 
<div class="row">
    <div class="col-12">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="view_order_items.php?order_id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-dark <?= $privilege['Select'] == '0' ? 'disabled' : '' ?>"> View &nbsp; <i class="fas fa-arrow-right"></i></a></td>
                                </tr>
