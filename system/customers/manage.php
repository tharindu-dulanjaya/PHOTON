...
$privilege = checkprivilege('2'); // 2 is the module id for Customer Management
?> 
<div class="row">
    <div class="col-12">
        <!--Filter section-->
        <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">            
            ...
            <a href="<?= SYS_URL ?>customers/add.php" class="btn btn-info <?= $privilege['Add'] == '0' ? 'disabled' : '' ?>"><i class="fas fa-user-plus"></i> New Customer</a>
